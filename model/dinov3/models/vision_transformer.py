...
def vit_base(patch_size=16, **kwargs):
    ...
    dino_checkpoint = "/mnt/Disk1/yezhaoyi/cell_Leukemia/model/dinov3/dinov3_vitb16_pretrain.pth"
    pretrained_dict = torch.load(dino_checkpoint)
    ...
    dino_model.load_state_dict(OrderedDict(model_dict), strict=True) 
...
def vit_large(patch_size=16, **kwargs):
    ...
    # model_dict = dino_model.state_dict()
    # dino_checkpoint = "/mnt/Disk1/yezhaoyi/cell_Leukemia/model/dinov3/dinov3_vitl16_pretrain.pth"
    # pretrained_dict = torch.load(dino_checkpoint)
